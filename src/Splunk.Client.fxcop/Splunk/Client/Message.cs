...
namespace Splunk.Client
{
    ...
    /// </summary>
    [Serializable]
    public sealed class Message : IComparable, IComparable<Message>, IEquatable<Message>, ISerializable
    {
        #region Constructors
        ...
        public void GetObjectData(SerializationInfo info, StreamingContext context)
        {
            ...
            info.AddValue("Type", (short)this.MessageType);
        ...
        Message(SerializationInfo info, StreamingContext context)
        {
            ...
            this.MessageType = (MessageType)info.GetUInt16("Type");
