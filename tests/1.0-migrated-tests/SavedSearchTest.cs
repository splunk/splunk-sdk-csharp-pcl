...
//            // set email params
//            savedSearch.Actions.Email.AuthPassword = "sdk-password";
//            savedSearch.Actions.Email.AuthUsername = "sdk-username";
//            savedSearch.Actions.Email.Bcc = "sdk-bcc@splunk.com";
//            savedSearch.Actions.Email.Cc = "sdk-cc@splunk.com";
//            savedSearch.Actions.Email.Command = "$name1$";
//            savedSearch.Actions.Email.Format = "text";
//            savedSearch.Actions.Email.From = "sdk@splunk.com";
//            savedSearch.Actions.Email.Hostname = "dummy1.host.com";
//            savedSearch.Actions.Email.Inline = true;
//            savedSearch.Actions.Email.MailServer = "splunk.com";
//            savedSearch.Actions.Email.MaxResults = 101;
//            savedSearch.Actions.Email.MaxTime = "10s";
//            savedSearch.Actions.Email.PdfView = "dummy";
//            savedSearch.Actions.Email.PreProcessResults = "*";
//            savedSearch.Actions.Email.ReportPaperOrientation = "landscape";
//            savedSearch.Actions.Email.ReportPaperSize = "letter";
//            savedSearch.Actions.Email.ReportServerEnabled = false;
//            savedSearch.Actions.Email.ReportServerUrl = "splunk.com";
//            savedSearch.Actions.Email.SendPdf = false;
//            savedSearch.Actions.Email.SendResults = false;
//            savedSearch.Actions.Email.Subject = "sdk-subject";
//            savedSearch.Actions.Email.To = "sdk-to@splunk.com";
//            savedSearch.Actions.Email.TrackAlert = false;
//            savedSearch.Actions.Email.Ttl = "61";
//            savedSearch.Actions.Email.UseSsl = false;
//            savedSearch.Actions.Email.UseTls = false;
//            savedSearch.Actions.Email.WidthSortColumns = false;
//            savedSearch.Actions.PopulateLookup.Command = "$name2$";
//            savedSearch.Actions.PopulateLookup.Dest = "dummypath";
//            savedSearch.Actions.PopulateLookup.Hostname = "dummy2.host.com";
//            savedSearch.Actions.PopulateLookup.MaxResults = 102;
//            savedSearch.Actions.PopulateLookup.MaxTime = "20s";
//            savedSearch.Actions.PopulateLookup.TrackAlert = false;
//            savedSearch.Actions.PopulateLookup.Ttl = "62";
//            savedSearch.Actions.Rss.Command = "$name3$";
//            savedSearch.Actions.Rss.Hostname = "dummy3.host.com";
//            savedSearch.Actions.Rss.MaxResults = 103;
//            savedSearch.Actions.Rss.MaxTime = "30s";
//            savedSearch.Actions.Rss.TrackAlert = false;
//            savedSearch.Actions.Rss.Ttl = "63";
...
//            savedSearch.Actions.SummaryIndex.Name = "default";
//            savedSearch.Actions.SummaryIndex.Command = "$name5$";
//            savedSearch.Actions.SummaryIndex.Hostname = "dummy5.host.com";
//            savedSearch.Actions.SummaryIndex.Inline = false;
//            savedSearch.Actions.SummaryIndex.MaxResults = 105;
//            savedSearch.Actions.SummaryIndex.MaxTime = "50s";
//            savedSearch.Actions.SummaryIndex.TrackAlert = false;
//            savedSearch.Actions.SummaryIndex.Ttl = "65";
