...
namespace Splunk.Sdk.UnitTesting
{
    ...
    public class MockContext : Context
    {
        ...
        public MockContext(Scheme protocol, string host, int port)
            ...
            new MockHttpMessageHandler(System.Configuration.ConfigurationSettings.AppSettings["MockContextName"], bool.Parse(ConfigurationSettings.AppSettings["IsRecording"])))
        { }
